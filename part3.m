...
xlabel('Allargament');
ylabel('CL');
%createfigure(A, CL, 'A', 'Allargament', 'CL', 'CL en funci� del allargament','CL_A');
...
xlabel('Allargament');
ylabel('CD');
%createfigure(A, CD, 'A', 'Allargament', 'CD', 'CD en funci� del allargament','CD_A');
...
xlabel('Allargament');
ylabel('Cm');
%createfigure(A, Cm, 'A', 'Allargament', 'Cm', 'Cm en funci� del allargament','Cm_A');